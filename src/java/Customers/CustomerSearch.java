...
public class CustomerSearch {
    ...
    public void getInfo() throws SQLException, ClassNotFoundException {
     ...
     public void checkVin()throws SQLException, ClassNotFoundException {
        ...
        ResultSet resultSet = dbInitializer.executeQuery("select * from vehicle where cus_id = '" 
                + getCus_id() +  "'");
        while (resultSet.next()) {
         setCus_id(resultSet.getString("cus_id")); 
         setVin(resultSet.getString("vin")); 
         setMake(resultSet.getString("make")); 
         setModel(resultSet.getString("model")); 
         setMyear(resultSet.getString("myear")); 
         setExterior(resultSet.getString("exterior")); 
         setInterior(resultSet.getString("interior")); 
    }
    }
